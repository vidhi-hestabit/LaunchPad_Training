...
class ImageSearch:
    ...
    def image_to_text_answer(self, image: Image.Image, top_k=3):
...
def image_query_llm(image: Image.Image, user_query: str, top_k=3):
    search = ImageSearch()
...
if __name__ == "__main__":
    ...
    if choice == "1":
        ...
        answer = image_query_llm(image_path, query)
        print("\nAnswer:\n", answer)
